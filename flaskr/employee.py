...
def employee_user_history():
    ...
    row = cursor.rowcount
    cursor.close()
    return render_template("employee/employee_user_history.html", emp_id=id, r=result, row=row)
...
def employee_rent_info():
    ...
    row = cursor.rowcount
    cursor.close()
    return render_template("employee/employee_rent_info.html", emp_id=id, r=result, row=row)
